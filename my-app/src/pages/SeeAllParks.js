...
const hoodSearch = queryParams.get('hood');
const addSearch = queryParams.get('add');
const nameSearch = queryParams.get('name');
...
function Park(props) {
	...
	if ((props.allowSE && data.quad == "SE" || props.allowSW && data.quad == "SW" 
										...
										&& (nameSearch === "none" || nameSearch === data.name)
										&& (addSearch  === "none" || addSearch  === data.street)
										&& (hoodSearch === "none" || hoodSearch === data.hood)) 
		return(
